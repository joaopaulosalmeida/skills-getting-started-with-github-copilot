            ...
            <ul class="participants-list">
              ${details.participants.map((participant) => `
                <li>
                  ...
                  <button type="button" class="remove-participant" data-activity="${name}" data-participant="${participant}" aria-label="Unregister ${participant}" title="Unregister participant">&#128465;</button>
                </li>
              `).join("")}
            </ul>
          </div>
